...
#'
#' rvn_write_flow_rvt generates a Raven rvt file from a flow series
#'
...
#' rvn_write_flow_rvt(obs,subID=36,stnName="Nith_Obs1",flip_number=1)
#'
#' # also write out the redirect file
#' rvn_write_flow_rvt(obs,subID=36,stnName="Nith_Obs1",write_redirect=T,flip_number=1)
#'}
#'
#' @export rvn_write_flow_rvt
rvn_write_flow_rvt <- function(flow.series,subID,stnName,rvt_type='ObservationData',prd=NULL,write_redirect=F,flip_number=F) {
