...
#' separate .rvt file
#' @param rd.file (optional) name of the redirect file created (if write_redirect = TRUE)
...
#'
#' # Create RVT files
#' rvn_tidyhydat_rvt(data, subIDs=c(3,11), stnNames=station_info$STATION_NAME, flip_number=T)
#'
