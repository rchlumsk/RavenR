...
#'
#' apply_wyearly calculates a function FUN for the periods defined by the water
...
#'
#' The apply_wyearly function applies to only one column at a time, otherwise
#' only the first column will be used, with a warning.
#'
#' @param x xts vector to calculate FUN for
#' @param FUN the function to be applied
#' @param ... optional arguments to FUN
#' @seealso \code{\link{apply_wyearly_cols}} for applying this function to
...
#' apply_wyearly(myforcings$forcings$temp_daily_ave,mean,na.rm=T
#'
#' # use apply_wyearly_cols to apply to multiple columns at once
