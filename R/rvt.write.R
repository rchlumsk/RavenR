...
#'
#' write.rvt generates a Raven rvt file from a time series
#'
...
#' rvt.write(hydrograph.data$hyd)
#'
#' @export rvt.write
rvt.write <- function(ts=NULL, prd=NULL, tt="00:00:00", dt=1.0, params=":Parameters XX",
