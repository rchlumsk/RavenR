...
#' \code{\link{rvn_rvh_cleanhrus}} for the function used to process HRU dataframes
...
rvn_rvh_write<-function(filename,SBtable,HRUtable)#add HRUgroups later
{
  write("# -------------------------------------------------",append=FALSE,file=filename)
  write("# .rvh file generated by RavenR rvn_rvh_write.R utility",append=TRUE,file=filename)
